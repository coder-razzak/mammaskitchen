                        ...
                        <form class="reservation-form" method="post" action="{{ route('reservation.reserve') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                            <input type="text" class="form-control reserve-form empty iconified" name="date_and_time" id="datatimepicker1" required="required" placeholder="&#xf017;  Time">
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, 2020 <a href="">Mammas Kitchen</a> Developed By - <a href="https://www.facebook.com/rakib.khr"  target="_blank">Rakib Khan</a>
                    </p>
                </div>
            </div>
        </div>
